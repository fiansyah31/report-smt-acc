...
class LaporanResult extends Model
{
    // Property yang dibutuhkan
    protected $table = "tbl_laporan";
    protected $column_order = [null, 'id_laporan', 'nama', 'tanggal', 'air_compresor', 'electric_room_cooler', 'breaker_mast', 'hyd_pump1',
    'hyd_pump2', 'traversing_unit', 'user_id', 'keterangan_laporan', null];
    protected $column_search = ['nama', 'tanggal', 'keterangan_laporan'];
    ...
    private function _get_datatables_query()
    {
        ...
        $this->model = $this->table($this->table)->select('id_laporan, nama, tanggal')->join('tbl_mesin', 'tbl_mesin.laporan_id = tbl_laporan.id_laporan');
